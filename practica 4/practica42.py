...
class practica42(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica42")
        ...
        self._K_win = RangeWidget(self._K_range, self.set_K, "USSB = 1 ; LSSB = -1", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, Am, 0, 0)
        ...
        self.connect((self.EnvolventecomplejaSSB_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.EnvolventecomplejaSSB_0.set_k(self.K)
...
def main(top_block_cls=practica42, options=None):
