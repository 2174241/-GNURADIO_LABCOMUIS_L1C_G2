...
class practica_3_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "practica 3_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("practica 3_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica_3_1")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 2200, 1, 0, 0)
...
def main(top_block_cls=practica_3_1, options=None):
