...
# Title: configuracionRSP
# Author: labcom_G2_L1C
...
class configuracionRSP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "configuracionRSP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("configuracionRSP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "configuracionRSP")
...
def main(top_block_cls=configuracionRSP, options=None):
