...
class practica5_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "coeficientes bessel", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("coeficientes bessel")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica5_2")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Fm, Ac, 0, 0)
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventeComplejaPM_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPM_0.set_Ac(self.Ac)
        self.analog_sig_source_x_0.set_amplitude(self.Ac)




def main(top_block_cls=practica5_2, options=None):
